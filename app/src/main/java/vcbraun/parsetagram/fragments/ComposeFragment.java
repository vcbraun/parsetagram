...
import vcbraun.parsetagram.LoginActivity;
import vcbraun.parsetagram.MainActivity;
...
public class ComposeFragment extends Fragment {
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(photoFile == null || ivPostImage.getDrawable() == null) {
                    Log.e(TAG, "No photo to save!");
                    Toast.makeText(getContext(), "No photo!", Toast.LENGTH_SHORT).show();
                    return;
                }
                savePost(description, author, photoFile);
            }
        });
    }
    ...
    private void savePost(String description, ParseUser author, File photoFile) {
        Post post = new Post();
